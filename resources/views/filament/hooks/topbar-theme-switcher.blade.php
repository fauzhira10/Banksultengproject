...
>
    <div class="inline-flex items-center gap-0.5 rounded-full border border-gray-200/90 bg-gray-100/90 p-1 shadow-xs backdrop-blur-xs transition-colors duration-300 dark:border-gray-700/80 dark:bg-gray-800/90">
        <!-- Mode Terang (Light) -->
        <button
            type="button"
            ...
            class="flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs cursor-pointer select-none transition-all duration-300 ease-out focus:outline-hidden"
            title="Mode Terang (Light Mode)"
        >
            <svg class="h-3.5 w-3.5 text-amber-500 shrink-0 transition-transform duration-300" style="width: 14px; height: 14px; min-width: 14px; min-height: 14px;" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        >
            <svg class="h-3.5 w-3.5 text-indigo-400 dark:text-blue-200 shrink-0 transition-transform duration-300" style="width: 14px; height: 14px; min-width: 14px; min-height: 14px;" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
